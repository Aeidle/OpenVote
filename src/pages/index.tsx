          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Create and manage elections, oversee candidate registrations, and view
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Register to vote, participate in active elections, and track the
                status of your votes securely.
              </p>
              <span className="text-blue-600 font-semibold inline-flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Blockchain-based security ensures tamper-proof voting records.
                </p>
              </div>
              <div className="text-center">
                <div className="bg-blue-100 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                ...
                <p className="text-gray-600">
                  Real-time tracking and verification of election results.
                </p>
              </div>
              <div className="text-center">
                <div className="bg-blue-100 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                ...
                <p className="text-gray-600">
                  Automated counting and immediate result publication.
                </p>
              </div>
            </div>
          </div>
